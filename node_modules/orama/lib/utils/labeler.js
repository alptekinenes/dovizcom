...
var Labeler = function Labeler() {
  ...
  function mcmove(currT) {
    ...
    var i = select_label_index(); // save old coordinates
    ...
    if (lab[i].y <= startY) lab[i].y = y_old; // new energy
  ...
  function set_movable_labels() {
    ...
    var old_labels = lab.map(function (d, i) {
      return i;
    }).filter(unchanged_from_last_selection); // indices of labels added with the selection change
  ...
  labeler.width = function () {
    // users insert graph width
    if (!arguments.length) return w;
    w = arguments.length <= 0 ? undefined : arguments[0];
    return labeler;
  };

  labeler.height = function () {
  ...
  labeler.label = function () {
    // users insert label positions
    if (!arguments.length) return lab;
    lab = arguments.length <= 0 ? undefined : arguments[0];
    return labeler;
  };

  labeler.anchor = function () {
    // users insert anchor positions
    if (!arguments.length) return anc;
    anc = arguments.length <= 0 ? undefined : arguments[0];
    return labeler;
  };

  labeler.alt_energy = function () {
    // user defined energy
    if (!arguments.length) return energy;
    user_defined_energy = arguments.length <= 0 ? undefined : arguments[0];
    user_energy = true;
    return labeler;
  };
  ...
  labeler.alt_schedule = function () {
    ...
    user_defined_schedule = arguments.length <= 0 ? undefined : arguments[0];
    user_schedule = true;
    return labeler;
  };
